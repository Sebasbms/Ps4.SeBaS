        ...
        <main class="w-full relative z-10 flex-1">
            ...
            <div id="tab-settings" class="tab-content pt-2">
                ...
                <div class="flex flex-col mt-6 glass-panel rounded-3xl p-4 shadow-[0_15px_30px_rgba(0,0,0,0.8)] border-white/10">
                    ...
                    <label class="text-[9px] text-gray-400 block mb-1 font-bold tracking-widest">ANIMACIÓN DE INICIO (INTRO)</label>
                    <select id="select-intro" onchange="localStorage.setItem('ps4_selected_intro', this.value); ps5Notification('INTRO GUARDADA', 'Se mostrará al reiniciar la app.', 'fa-film');" class="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-xs text-white mb-4 outline-none focus:border-[var(--theme-prim)] shadow-inner">
                        <option value="none">Sin Intro (Arranque Rápido)</option>
                        <option value="intro-ps5">1. PS5 Nebula Blue</option>
                        <option value="intro-ps4">2. PS4 Classic</option>
                        <option value="intro-glitch">3. Cyber Glitch</option>
                        <option value="intro-ps2">4. PS2 Nostalgia</option>
                        <option value="intro-hud">5. Sci-Fi HUD</option>
                        <option value="intro-neon">6. Neon Synthwave</option>
                        <option value="intro-decrypt">7. Data Decrypt</option>
                        <option value="intro-arcade">8. Retro Arcade</option>
                        <option value="intro-matrix-rain">9. Matrix Rain</option>
                        <option value="intro-crt">10. Boot CRT</option>
                        <option value="intro-gb">11. Game Boy</option>
                        <option value="intro-breach">12. Access Granted</option>
                    </select>

                    <label class="text-[9px] text-gray-400 block mb-1 font-bold tracking-widest">FONDOS ANIMADOS (LIVE BG)</label>
                    <select id="select-wallpaper" onchange="changeDynamicWallpaper(this.value); ps5Notification('FONDO APLICADO', 'Animación en vivo activada.', 'fa-bolt');" class="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-xs text-white outline-none focus:border-[var(--theme-prim)] shadow-inner">
                        <option value="none">Fondo Estático de Imagen</option>
                        <option value="bg-ps5">1. PS5 Nebula Blue</option>
                        <option value="bg-ps5-gold">2. PS5 Golden Flow</option>
                        <option value="bg-ps4">3. PS4 Geometry</option>
                        <option value="bg-ps3">4. PS3 Classic XMB</option>
                        <option value="bg-ps2">5. PS2 Crystal Abyss</option>
                        <option value="bg-ps1">6. PS1 Retro Boot</option>
                        <option value="bg-matrix">7. Matrix Rain</option>
                        <option value="bg-binary">8. Binary Pulse</option>
                        <option value="bg-circuit">9. Cyber Circuit</option>
                        <option value="bg-network">10. Neural Net</option>
                        <option value="bg-starfield">11. 8-Bit Stars</option>
                        <option value="bg-warp">12. Warp Drive</option>
                        <option value="bg-radar">13. Radar Sweep</option>
                        <option value="bg-synth">14. Synthwave Grid</option>
                        <option value="bg-fiber">15. Data Streams</option>
                        <option value="bg-sonar">16. Deep Sonar</option>
                        <option value="bg-plasma">17. Dark Fluid Plasma</option>
                    </select>
                </div>
